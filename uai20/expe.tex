...
Note that we used the same method for the weighted version of the SBM models of the Aicher and Peixoto models as we observed eihter no significative difference or even better results using the later.
